\name{RodFramedata}
\docType{data}
\title{Rod and Frame Task Data Set}
\alias{RodFramedata}
\usage{RodFramedata}
\description{
  This data set involves assessing children longitudinally at 6 age points from ages 4 through 18 years for the rod and
...
\format{This data frame consists of 140 children (the rows).  Column 1 is the subject number and column 
...
\source{
  Thomas, H. and Dahlin, M. P. (2005) Individual Development and Latent Groups: Analytical Tools for Interpreting Heterogeneity,
  \emph{Developmental Review} \bold{25(2)}, 133--154.
}
\keyword{datasets}
